...
class CheckUpdateAsyncTask extends AsyncTask{
	...
	private const RELEASE_URL = "https://api.github.com/repos/PresentKim/Lullaby-PMMP/releases/latest";
	...
	public function __construct(){
		$this->cachePath = Lullaby::getInstance()->getDataFolder() . ".latestCache";
	}
